...
namespace DynamoChallenge2
{
    public class Function
    {
        ...
        private IModelStore<DynamoChallenge2Inputs> store;

        public async Task<DynamoChallenge2Outputs> Handler(DynamoChallenge2Inputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<DynamoChallenge2Inputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<DynamoChallenge2Inputs,DynamoChallenge2Outputs>(store, DynamoChallenge2.Execute);
